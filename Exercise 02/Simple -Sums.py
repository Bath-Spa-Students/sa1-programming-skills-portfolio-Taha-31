...
# sum of 2 numbers through variables

number_1 = 8 # first variable storing the integer 8
number_2 = 10 # second variable storing the integer 10
number_3 = number_1 + number_2 # third variable that stores the sum of the first two variables

print(number_3) # print statement that prints the third variable 
